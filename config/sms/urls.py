...
urlpatterns = [
    ...
    path('voluntary_hazard_reports_dashboard/', views.voluntary_hazard_reports_dashboard, name='voluntary_hazard_reports_dashboard'),
    ...
    path('voluntary_hazard_report/<int:report_id>/process/', views.process_rvp, name='process_rvp'),
    ...
    path('report_with_mmrs/<int:report_id>/', views.report_with_mmrs_detail, name='report_with_mmrs_detail'),
