...
urlpatterns = [
    ...
    path('instructor_stats/', views.instructor_stats_page, name='instructor_stats_page'),
     ...
     path('submit_external_flight_evaluation/', views.submit_external_flight_evaluation, name='external_flight_evaluation'),
     path('external_evaluations/', views.external_evaluations, name='external_evaluations'),
