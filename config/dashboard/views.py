...
def _build_launchpad_apps(request, active_role, user_profile):
    ...
    apps = [
        ...
        },
        {
            ...
            'icon': 'dashboard/img/transcript.png',
        ...
        },
        {
            ...
            'icon': 'dashboard/img/flightlog.png',
        ...
        },
        {
            ...
            'icon': 'dashboard/img/addGrade.png',
        ...
        },
        {
            ...
            'icon': 'dashboard/img/calendar.png',
