    ...
    fieldsets = (
        ...
        ('Información del estudiante', {
            'fields': ('student_age', 'student_gender', 'student_phase', 
                       'student_license_type', 'license_exp_date', 'sim_hours', 'nav_flight_hours', 'flight_hours', 'advanced_student')
        }),
...
class InstructorProfileAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ('Información del instructor', {
            'fields': ('instructor_type', 'instructor_license_type', 'license_exp_date', 'instructor_hourly_rate')
        }),
    )
